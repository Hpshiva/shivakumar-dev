  ...
  projects: [
    {
      id: "01",
      title: "Agan Health",
      description: "An elite digital healthcare platform featuring therapist matching algorithms, video consultation integrations, and an instant booking engine.",
    ...
    },
    {
      ...
      description: "High-performance automotive platform transforming dealership leads with vehicle customizers and real-time test-drive bookings.",
    ...
    },
    {
      ...
      description: "Modern web solution for vehicle discovery, catalog filtering, price calculations, and trade-in workflows.",
      image: "./images/pristine_renault.png",
      tags: ["React.js", "Figma-to-Code", "REST APIs"],
    ...
    },
    {
      ...
      description: "Campaign-led fintech platform featuring dynamic media assets, optimized lead generation, and fast calculation tools.",
      image: "./images/kinara_capital.png",
      tags: ["React.js", "GSAP Animations", "Tailwind"],
